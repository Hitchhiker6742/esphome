...
uponor_smatrix_ns = cg.esphome_ns.namespace("uponor_smatrix145")
...
CONF_SYSTEM_ADDRESS = "system_address"
...
UPONOR_SMATRIX_DEVICE_SCHEMA = cv.Schema(
    {
        ...
        cv.Required(CONF_SYSTEM_ADDRESS): cv.hex_uint16_t,
...
async def register_uponor_smatrix_device(var, config):
    ...
    cg.add(var.set_system_address(config[CONF_SYSTEM_ADDRESS]))
